    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent data-testid="approve-wave-dialog" className="sm:max-w-lg max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-3 py-2">
          {/* Hold policy explanation */}
          <div className="flex items-start gap-2 p-2 rounded bg-blue-50 border border-blue-100 text-[10px] text-blue-700" data-testid="hold-policy-explanation">
            <span className="mt-0.5 shrink-0">ℹ</span>
            <span>Lines you don't approve will be placed on <strong>hold</strong>. The requester can re-request held items later, or cancel the held portion.</span>
          </div>
