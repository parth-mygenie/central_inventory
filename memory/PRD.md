...
Clone repo, fix G-031, raise timeout to 100s, add loading UI, add Select All/Unselect All, remove invoice total, fix consumption report date crash.
...
- [2026-07-15] BUG-FIX: Guarded dateRange null/empty in Consumption Report (Invalid time value crash)
