...
Clone repo, fix G-031, raise timeout to 100s, add loading UI, add Select All / Unselect All to PO Create + Direct Dispatch, remove invoice total multiplication from Receive Goods.
...
- [2026-07-15] CR-046: Select All / Unselect All in PO Create (both By Vendor + By Item Need)
- [2026-07-15] BUG-FIX: Commented out Invoice Total (qty×rate) display on Receive Goods
- [2026-07-15] CR-046: Select All / Unselect All added to Direct Dispatch form
